    ...
    <div className="relative w-16 h-16">
        ...
        >
            ...
            <path
                ...
                className="fill-orange-100 dark:fill-orange-900/30 stroke-orange-500 dark:stroke-orange-400"
                strokeWidth="2"
            >
                <animate
                    attributeName="d"
...
export default function FileUpload({
    ...
    return (
        ...
        >
            <div className="group relative w-full rounded-xl bg-muted ring-1 ring-gray-200 dark:ring-white/10 p-0.5">
